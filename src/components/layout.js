    ...
    return (
        <html lang="en" class="flex flex-col h-screen justify-between">
            ...
            <footer className="text-center py-8 text-cyan-500 dark:bg-zinc-700 bg-zinc-700">
                ...
                <p className="font-archivoNarrow text-l hover:opacity-100 opacity-60"><Link to="mailto:mosterm@uncw.edu">mosterm@uncw.edu</Link></p>
                <p className="font-bebasNeue text-xl">Makayla Moster &copy; 2025</p>
            </footer>
        </html>
    )
}
