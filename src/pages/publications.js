...
const PublicationsPage = () => {
  return (
    <Layout pageTitle='Publications'>
      <h1 className='font-archivoNarrow text-3xl'>2023</h1>
      <br />
      <ul>
      ...
      <ul>
        ...
        <li><span className="text-cyan-500 hover:opacity-60 font-archivoNarrow"><Link to="https://github.com/makayla-moster/pdfs/blob/master/papers/2023_CSCW_BothSidesoftheStory.pdf" target="_blank">pre-print</Link></span></li>
        <li>*denotes co-first authorship</li>
      </ul>

      <br />
      <h1 className='font-archivoNarrow text-3xl'>2022</h1>
      <br />
      <ul>
        ...
        <li><span className="text-cyan-500 hover:opacity-60 font-archivoNarrow"><Link to="https://github.com/makayla-moster/pdfs/blob/master/papers/2022_ESEM_NewIdea_Paper.pdf" target="_blank">pre-print</Link></span> | <span className="text-cyan-500 hover:opacity-60 font-archivoNarrow"><Link to="https://github.com/makayla-moster/pdfs/blob/master/slides/2022_ESEM_Presentation_Rodeghero.pdf" target="_blank">slides</Link></span></li>
      </ul>
      <br />
      <ul>
        ...
        <li><span className="text-cyan-500 hover:opacity-60 font-archivoNarrow"><Link to="https://github.com/makayla-moster/pdfs/blob/master/slides/2022_ICER_Slide.pdf" target="_blank">slide</Link></span> | <span className="text-cyan-500 hover:opacity-60 font-archivoNarrow"><Link to="https://github.com/makayla-moster/pdfs/blob/master/slides/2022_ICER_Poster.pdf" target="_blank">poster</Link></span></li>
      </ul>
      <br />
      <ul>
        ...
        <li><span className="text-cyan-500 hover:opacity-60 font-archivoNarrow"><Link to="https://github.com/makayla-moster/pdfs/blob/master/papers/2022_MSFT_AutismAtWork_Workshop.pdf" target="_blank">paper</Link></span></li>
      </ul>
      <br />
      <ul>
        ...
        <li><span className="text-cyan-500 hover:opacity-60 font-archivoNarrow"><Link to="https://github.com/makayla-moster/pdfs/blob/master/papers/2022_ICSE_SEET_Experience_Report.pdf" target="_blank">pre-print</Link></span> | <span className="text-cyan-500 hover:opacity-60 font-archivoNarrow"><Link to="https://zenodo.org/record/5902445" target="_blank">materials</Link></span> | <span className="text-cyan-500 hover:opacity-60 font-archivoNarrow"><Link to="https://youtu.be/YGufCW6Mq4c?si=OBALjJ-xidLZ-5VE" target="_blank">ICSE talk</Link></span> | <span className="text-cyan-500 hover:opacity-60 font-archivoNarrow"><Link to="https://github.com/makayla-moster/pdfs/blob/master/slides/2022_SEET_ExperienceReport.pdf" target="_blank">slides</Link></span></li>
      </ul>

      <br />
      <h1 className='font-archivoNarrow text-3xl'>2021</h1>
      <br />
      <ul>
      ...
      <br />
      <h1 className='font-archivoNarrow text-3xl'>2020</h1>
      <br />
      <ul>
      ...
      <br />
      <h1 className='font-archivoNarrow text-3xl'>Undergraduate Research</h1>
      <br />
      <ul>
        ...
        <ul>
          ...
          <li><span className="text-cyan-500 hover:opacity-60 font-archivoNarrow"><Link to="https://github.com/makayla-moster/pdfs/blob/master/slides/Makayla_Moster.pdf" target="_blank">poster</Link></span> | <span className="text-cyan-500 hover:opacity-60 font-archivoNarrow"><Link to="https://github.com/makayla-moster/CSC_499" target="_blank">github</Link></span></li>
        </ul>
        <br />
        <ul>
          <li><strong>Generating Plant Models using Fractals</strong> (2018)</li>
          <li><span className="text-cyan-500 hover:opacity-60 font-archivoNarrow"><Link to="https://github.com/makayla-moster/pdfs/blob/master/slides/Poster.pdf" target="_blank">poster</Link></span> | <span className="text-cyan-500 hover:opacity-60 font-archivoNarrow"><Link to="https://github.com/makayla-moster/FractalTree" target="_blank">github</Link></span></li>
        </ul>
      </ul>
    </Layout>
  )
