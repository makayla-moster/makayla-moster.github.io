...
const IndexPage = () => {
  return (
    <Layout pageTitle='Hello World!'>
      <p>Hiya! My name is Makayla Moster and I'm a <span className="text-cyan-500">Computer Science Ph.D. Student at Clemson University</span>. <br/> I am a member of the <span className="text-cyan-500 hover:opacity-60"><Link to="http://clemsonhfse.com" target='_blank'>Human Factors Software Engineering lab</Link></span> under the guidance of <span className="text-cyan-500 hover:opacity-60"><Link to="https://paigerodeghero.com" target="_blank">Dr. Paige Rodeghero</Link></span>.</p> 
      <br />
      <div className="flex lg:mx-auto  space-x-3 grid-flow-row">
      ...
      <br />
      <p>I graduated from the University of North Carolina Wilmington with my B.S. (Honors) in Computer Science. During my time at Clemson, I have completed my M.S. in Computer Science and my Graduate Certificate in Engineering and Science Education.</p>
      <br />
      <p>In my limited spare time, I mostly enjoy reading novels and playing videogames. I also dabble in crafting; I am a tie dye enthusiast and a hobby crocheter. Lastly, I enjoy going on walks with my <span className="text-cyan-500 hover:opacity-60"><Link to="https://michael-byrd.github.io" target="_blank">fiancé</Link></span> and cat, Gizmo.</p>
