...
const IndexPage = () => {
  return (
    <Layout pageTitle='Hello World!'>
      ...
      <p className='pb-5'>Hiya! My name is Makayla Moster and I am an <span className="text-cyan-500">Assistant Professor</span> at the <span className="text-cyan-500">University of North Carolina Wilmington</span>.</p> 
