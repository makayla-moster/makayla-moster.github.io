...
const IndexPage = () => {
  return (
    <Layout pageTitle='Hello World!'>
      ...
      <p className='pb-5'>Hiya! My name is Makayla Moster and I am an <span className="text-cyan-500">incoming Assistant Professor</span> at the <span className="text-cyan-500">University of North Carolina Wilmington</span>.</p> 
      
      <div className="flex lg:mx-auto space-x-3 grid-flow-row pb-5">
      <StaticImage className="" width="960" alt="Words" src="../images/Norway_MM.jpeg"/>
      ...
      <p className='pb-5'>My research focuses on <span className="text-cyan-500">teamwork</span>, <span className="text-cyan-500">computer-mediated communication tools</span>, and <span className="text-cyan-500">informal learning communities</span>. <br/>
        I have two goals for my research: 
        <ol className='pl-10'>
          <li><span className="text-cyan-500">1.</span> I want to further our understanding of informal online education-based communities and how/if they impact students’ formal education.</li>
          <li><span className="text-cyan-500">2.</span> I want to improve the student teamwork experience through CMC tools.</li>
        </ol>
