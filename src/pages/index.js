...
const IndexPage = () => {
  return (
    <Layout pageTitle='Hello World!'>
      ...
      <p   className='pb-5 text-center'>You can find my application materials <span className="text-cyan-500 hover:opacity-60"><Link to='/appmats'>here soon</Link></span>.</p>
      ...
      <p className='pb-5'>In my limited spare time, I mostly enjoy reading novels and playing videogames. I also dabble in crafting; I am a tie dye enthusiast, a hobby crocheter, and have recently started sewing bandanas for my cat. Lastly, I enjoy going on walks with my <span className="text-cyan-500 hover:opacity-60"><Link to="https://michael-byrd.github.io" target="_blank">fiancé</Link></span> and cat, Gizmo.</p>
