...
const TeachingPage = () => {
    return (
        <Layout pageTitle="Courses">
            <h1 className='font-archivoNarrow text-3xl pb-3'>Courses taught at UNCW</h1>
            <ul className='pb-8'>
            ...
            <h1 className='font-archivoNarrow text-3xl pb-3'>Courses TA-ed at Clemson University</h1>
            <ul className='pb-8'>
