...
const JobPage = () => {
    return (
        <Layout pageTitle="Application Materials">
            ...
            <p className='pb-5'>If you are interested in collaborating or know of a position I would be right for, please contact me at <span className="text-cyan-500 hover:opacity-60"><Link to="mailto:mmoster@clemson.edu">mmoster@clemson.edu</Link></span>!</p>
        </Layout>
    )
}
